...
//******************************  APRS CONFIG **********************************
char CallSign[5] = "A4VU";          //DO NOT FORGET TO CHANGE YOUR CALLSIGN
...
float WsprBattMin = 1000;   //min Volts for HF mradio module to transmit (TX) ~10 mW

//******************************  HF CONFIG *************************************

char hf_call[5] = "A4VU";  //DO NOT FORGET TO CHANGE YOUR CALLSIGN
...
byte configDra818(char *freq) {
  ...
  pinMode(PIN_DRA_TX, INPUT);
#if defined(DEVMODE)
  if (ack[0] == 0x30) Serial.println(F("Frequency updated..."));
  else Serial.println(F("Frequency update error!"));
#endif
